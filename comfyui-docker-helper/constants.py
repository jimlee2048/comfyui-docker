...
BOOT_PRE_INIT_SCRIPTS = BOOT_SCRIPTS_DIR / "pre-init"
BOOT_POST_INSTALL_NODE_SCRIPTS = BOOT_SCRIPTS_DIR / "post-install-node"
BOOT_POST_INIT_SCRIPTS = BOOT_SCRIPTS_DIR / "post-init"
